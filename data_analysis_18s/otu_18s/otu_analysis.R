...
pacman::p_load(pacman, dplyr, readxl, ggplot2, phyloseq, microbiome, reshape2, ape, gridExtra, plotly, vegan, dendextend, tidyr, rms, effectsize, lme4, picante, cowplot, here, lsr, MASS, rcompanion, ggiraphExtra, optimx, mvabund, gllvm, radiant.data, tidyverse, MuMIn, corrplot, gclus, coefplot, jtools, ggstance, interactions)
here()
...
## For Observed
glmm_algae_phylum_block_alpha_Observed_ris <- glmer(Observed ~ nutrient*sediment*flow*time + (nutrient|header_tanks_block)+ (sediment|header_tanks_block)+ (flow|header_tanks_block)+ (time|header_tanks_block), family = poisson(link = "log"), data = alpha_lm_algae_phylum_1)
...
## For Shannon
glmm_algae_phylum_block_alpha_Shannon_ris <- glmer(Shannon_1 ~ nutrient*sediment*flow*time + (nutrient|header_tanks_block)+ (sediment|header_tanks_block)+ (flow|header_tanks_block)+ (time|header_tanks_block), family = poisson(link = "log"), data = alpha_lm_algae_phylum_1)
...
## For Pielou
glmm_algae_phylum_block_alpha_pielou_ris <- glmer(pielou_1 ~ nutrient*sediment*flow*time + (nutrient|header_tanks_block)+ (sediment|header_tanks_block)+ (flow|header_tanks_block)+ (time|header_tanks_block), family = poisson(link = "log"), data = alpha_lm_algae_phylum_1)
...
## For Observed
glmm_algae_genus_block_alpha_Observed_ris <- glmer(Observed ~ nutrient*sediment*flow*time + (nutrient|header_tanks_block)+ (sediment|header_tanks_block)+ (flow|header_tanks_block)+ (time|header_tanks_block), family = poisson(link = "log"), data = alpha_lm_algae_genus_1)
...
## For Shannon
glmm_algae_genus_block_alpha_Shannon_ris <- glmer(Shannon_2 ~ nutrient*sediment*flow*time + (nutrient|header_tanks_block)+ (sediment|header_tanks_block)+ (flow|header_tanks_block)+ (time|header_tanks_block), family = poisson(link = "log"), data = alpha_lm_algae_genus_1)
...
## For Pielou
glmm_algae_genus_block_alpha_pielou_ris <- glmer(pielou_2 ~ nutrient*sediment*flow*time + (nutrient|header_tanks_block)+ (sediment|header_tanks_block)+ (flow|header_tanks_block)+ (time|header_tanks_block), family = poisson(link = "log"), data = alpha_lm_algae_genus_1)
...
## For Observed
glmm_protist_phylum_block_alpha_Observed_ris <- glmer(Observed ~ nutrient*sediment*flow*time + (nutrient|header_tanks_block)+ (sediment|header_tanks_block)+ (flow|header_tanks_block)+ (time|header_tanks_block), family = poisson(link = "log"), data = alpha_lm_protist_phylum_1)
...
## For Shannon
glmm_protist_phylum_block_alpha_Shannon_ris <- glmer(Shannon_3 ~ nutrient*sediment*flow*time + (nutrient|header_tanks_block)+ (sediment|header_tanks_block)+ (flow|header_tanks_block)+ (time|header_tanks_block), family = poisson(link = "log"), data = alpha_lm_protist_phylum_1)
...
## For Pielou
glmm_protist_phylum_block_alpha_pielou_ris <- glmer(pielou_3 ~ nutrient*sediment*flow*time + (nutrient|header_tanks_block)+ (sediment|header_tanks_block)+ (flow|header_tanks_block)+ (time|header_tanks_block), family = poisson(link = "log"), data = alpha_lm_protist_phylum_1)
...
## For Observed
glmm_protist_genus_block_alpha_Observed_ris <- glmer(Observed ~ nutrient*sediment*flow*time + (nutrient|header_tanks_block)+ (sediment|header_tanks_block)+ (flow|header_tanks_block)+ (time|header_tanks_block), family = poisson(link = "log"), data = alpha_lm_protist_genus_1)
...
## For Shannon
glmm_protist_genus_block_alpha_Shannon_ris <- glmer(Shannon_4 ~ nutrient*sediment*flow*time + (nutrient|header_tanks_block)+ (sediment|header_tanks_block)+ (flow|header_tanks_block)+ (time|header_tanks_block), family = poisson(link = "log"), data = alpha_lm_protist_genus_1)
...
## For Pielou
glmm_protist_genus_block_alpha_pielou_ris <- glmer(pielou_4 ~ nutrient*sediment*flow*time + (nutrient|header_tanks_block)+ (sediment|header_tanks_block)+ (flow|header_tanks_block)+ (time|header_tanks_block), family = poisson(link = "log"), data = alpha_lm_protist_genus_1)
