...
sample_data(phyloseq_object)$treatment <- factor(sample_data(phyloseq_object)$treatment, levels = c("C", "N", "F", "S", "NF", "NS", "SF", "NFS"))
levels(sample_data(phyloseq_object)$treatment)
...
colSums(sub_algae_phylum_tsc_minthreshold_b) ## Coverage
...
colSums(sub_algae_order_tsc_minthreshold_b) ## Coverage
...
colSums(sub_protist_phylum_tsc_minthreshold_b) ## Coverage
...
colSums(sub_protist_order_tsc_minthreshold_b) ## Coverage
...
alpha_lm_algae_phylum_11 <- alpha_lm_algae_phylum_1 %>% mutate(across(c(week, flow, sediment, nutrient, time, header_tanks_block, treatment_week), as.factor))
...
alpha_lm_algae_order_11 <- alpha_lm_algae_order_1 %>% mutate(across(c(week, flow, sediment, nutrient, time, header_tanks_block, treatment_week), as.factor))
...
alpha_lm_protist_phylum_11 <- alpha_lm_protist_phylum_1 %>% mutate(across(c(week, flow, sediment, nutrient, time, header_tanks_block, treatment_week), as.factor))
...
alpha_lm_protist_order_11 <- alpha_lm_protist_order_1 %>% mutate(across(c(week, flow, sediment, nutrient, time, header_tanks_block, treatment_week), as.factor))
...
ap_ob.gls <- gls(Observed ~ nutrient*sediment*flow*time, data = alpha_lm_algae_phylum_11)
plot(ap_ob.gls)
summary(ap_ob.gls)
### To fit a linear mixed model
lmm_algae_phylum_Observed <- lme(Observed ~ nutrient*sediment*flow*time, random = ~ 1 | header_tanks_block, method = "REML",  data = alpha_lm_algae_phylum_11)
...
lm_algae_phylum_Observed <- lm(Observed ~ nutrient*sediment*flow*time, data = alpha_lm_algae_phylum_11)
...
plot_ao_ap_ob <- ggplot(alpha_lm_algae_phylum_11, aes(x = treatment, y = Observed, fill = treatment))+
...
apoi_t2 <- alpha_lm_algae_phylum_11 %>% filter(week == 2)
apoi_t3 <- alpha_lm_algae_phylum_11 %>% filter(week == 3)

par(mfrow=c(1,1))
interaction.plot(apoi_t2$nutrient,apoi_t2$flow,apoi_t2$Observed,type = "b",col=c(1:3),
...
interaction.plot(apoi_t3$nutrient,apoi_t3$flow,apoi_t3$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(apoi_t2$nutrient,apoi_t2$sediment,apoi_t2$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(apoi_t3$nutrient,apoi_t3$sediment,apoi_t3$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(apoi_t2$sediment,apoi_t2$flow,apoi_t2$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(apoi_t3$sediment,apoi_t3$flow,apoi_t3$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
apsi_t2 <- alpha_lm_algae_phylum_11 %>% filter(week == 2)
apsi_t3 <- alpha_lm_algae_phylum_11 %>% filter(week == 3)

par(mfrow=c(1,1))
interaction.plot(apsi_t2$nutrient,apsi_t2$flow,apsi_t2$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(apsi_t3$nutrient,apsi_t3$flow,apsi_t3$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(apsi_t2$nutrient,apsi_t2$sediment,apsi_t2$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(apsi_t3$nutrient,apsi_t3$sediment,apsi_t3$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(apsi_t2$sediment,apsi_t2$flow,apsi_t2$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(apsi_t3$sediment,apsi_t3$flow,apsi_t3$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
appi_t2 <- alpha_lm_algae_phylum_11 %>% filter(week == 2)
appi_t3 <- alpha_lm_algae_phylum_11 %>% filter(week == 3)

par(mfrow=c(1,1))
interaction.plot(appi_t2$nutrient,appi_t2$flow,appi_t2$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(appi_t3$nutrient,appi_t3$flow,appi_t3$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(appi_t2$nutrient,appi_t2$sediment,appi_t2$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(appi_t3$nutrient,appi_t3$sediment,appi_t3$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(appi_t2$sediment,appi_t2$flow,appi_t2$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(appi_t3$sediment,appi_t3$flow,appi_t3$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
aooi_t2 <- alpha_lm_algae_order_11 %>% filter(week == 2)
aooi_t3 <- alpha_lm_algae_order_11 %>% filter(week == 3)

par(mfrow=c(1,1))
interaction.plot(aooi_t2$nutrient,aooi_t2$flow,aooi_t2$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(aooi_t3$nutrient,aooi_t3$flow,aooi_t3$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(aooi_t2$nutrient,aooi_t2$sediment,aooi_t2$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(aooi_t3$nutrient,aooi_t3$sediment,aooi_t3$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(aooi_t2$sediment,aooi_t2$flow,aooi_t2$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(aooi_t3$sediment,aooi_t3$flow,aooi_t3$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
aosi_t2 <- alpha_lm_algae_order_11 %>% filter(week == 2)
aosi_t3 <- alpha_lm_algae_order_11 %>% filter(week == 3)

par(mfrow=c(1,1))
interaction.plot(aosi_t2$nutrient,aosi_t2$flow,aosi_t2$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(aosi_t3$nutrient,aosi_t3$flow,aosi_t3$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(aosi_t2$nutrient,aosi_t2$sediment,aosi_t2$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(aosi_t3$nutrient,aosi_t3$sediment,aosi_t3$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(aosi_t2$sediment,aosi_t2$flow,aosi_t2$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(aosi_t3$sediment,aosi_t3$flow,aosi_t3$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
aopi_t2 <- alpha_lm_algae_order_11 %>% filter(week == 2)
aopi_t3 <- alpha_lm_algae_order_11 %>% filter(week == 3)

par(mfrow=c(1,1))
interaction.plot(aopi_t2$nutrient,aopi_t2$flow,aopi_t2$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(aopi_t3$nutrient,aopi_t3$flow,aopi_t3$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(aopi_t2$nutrient,aopi_t2$sediment,aopi_t2$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(aopi_t3$nutrient,aopi_t3$sediment,aopi_t3$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(aopi_t2$sediment,aopi_t2$flow,aopi_t2$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(aopi_t3$sediment,aopi_t3$flow,aopi_t3$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
pp_ob.gls <- gls(Observed ~ nutrient*sediment*flow*time, data = alpha_lm_protist_phylum_11)
plot(pp_ob.gls)
summary(pp_ob.gls)
### To fit a linear mixed model
lmm_protist_phylum_Observed <- lme(Observed ~ nutrient*sediment*flow*time, random = ~ 1 | header_tanks_block, method = "REML",  data = alpha_lm_protist_phylum_11)
plot(lmm_protist_phylum_Observed)
summary(lmm_protist_phylum_Observed)
### To compare the models
anova(pp_ob.gls, lmm_protist_phylum_Observed)
### To fit the final model
lm_protist_phylum_Observed <- lm(Observed ~ nutrient*sediment*flow*time, data = alpha_lm_protist_phylum_11)
...
plot_ao_pp_ob <- ggplot(alpha_lm_protist_phylum_11, aes(x = treatment, y = Observed, fill = treatment))+
  stat_summary(geom = "bar", fun = mean)+
  stat_summary(geom = "errorbar", fun.data = mean_se, width=.1,position=position_dodge(.9))+
  facet_wrap(~week, labeller = labeller(week = c("2" = "After two weeks", "3" = "After three weeks")))+
  theme_classic()+
...
ppoi_t2 <- alpha_lm_protist_phylum_11 %>% filter(week == 2)
ppoi_t3 <- alpha_lm_protist_phylum_11 %>% filter(week == 3)

par(mfrow=c(1,1))
interaction.plot(ppoi_t2$nutrient,ppoi_t2$flow,ppoi_t2$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(ppoi_t3$nutrient,ppoi_t3$flow,ppoi_t3$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(ppoi_t2$nutrient,ppoi_t2$sediment,ppoi_t2$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(ppoi_t3$nutrient,ppoi_t3$sediment,ppoi_t3$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(ppoi_t2$sediment,ppoi_t2$flow,ppoi_t2$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(ppoi_t3$sediment,ppoi_t3$flow,ppoi_t3$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
ppsi_t2 <- alpha_lm_protist_phylum_11 %>% filter(week == 2)
ppsi_t3 <- alpha_lm_protist_phylum_11 %>% filter(week == 3)

par(mfrow=c(1,1))
interaction.plot(ppsi_t2$nutrient,ppsi_t2$flow,ppsi_t2$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(ppsi_t3$nutrient,ppsi_t3$flow,ppsi_t3$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(ppsi_t2$nutrient,ppsi_t2$sediment,ppsi_t2$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(ppsi_t3$nutrient,ppsi_t3$sediment,ppsi_t3$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(ppsi_t2$sediment,ppsi_t2$flow,ppsi_t2$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(ppsi_t3$sediment,ppsi_t3$flow,ppsi_t3$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
### To fit a linear model with the gls function
pp_pi.gls <- gls(pielou ~ nutrient*sediment*flow*time, data = alpha_lm_protist_phylum_11)
plot(pp_pi.gls)
summary(pp_pi.gls)
### To fit a linear mixed model
lmm_protist_phylum_pielou <- lme(pielou ~ nutrient*sediment*flow*time, random = ~ 1 | header_tanks_block, method = "REML",  data = alpha_lm_protist_phylum_11)
plot(lmm_protist_phylum_pielou)
summary(lmm_protist_phylum_pielou)
### To compare the models
anova(pp_pi.gls, lmm_protist_phylum_pielou)
### To fit the final model
lm_protist_phylum_pielou <- lm(pielou ~ nutrient*sediment*flow*time, data = alpha_lm_protist_phylum_11)
...
plot_ao_pp_pi <- ggplot(alpha_lm_protist_phylum_11, aes(x = treatment, y = pielou, fill = treatment))+
  stat_summary(geom = "bar", fun = mean)+
  stat_summary(geom = "errorbar", fun.data = mean_se, width=.1,position=position_dodge(.9))+
  facet_wrap(~week, labeller = labeller(week = c("2" = "After two weeks", "3" = "After three weeks")))+
  theme_classic()+
...
pppi_t2 <- alpha_lm_protist_phylum_11 %>% filter(week == 2)
pppi_t3 <- alpha_lm_protist_phylum_11 %>% filter(week == 3)

par(mfrow=c(1,1))
interaction.plot(pppi_t2$nutrient,pppi_t2$flow,pppi_t2$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(pppi_t3$nutrient,pppi_t3$flow,pppi_t3$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(pppi_t2$nutrient,pppi_t2$sediment,pppi_t2$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(pppi_t3$nutrient,pppi_t3$sediment,pppi_t3$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(pppi_t2$sediment,pppi_t2$flow,pppi_t2$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(pppi_t3$sediment,pppi_t3$flow,pppi_t3$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
pooi_t2 <- alpha_lm_protist_order_11 %>% filter(week == 2)
pooi_t3 <- alpha_lm_protist_order_11 %>% filter(week == 3)

par(mfrow=c(1,1))
interaction.plot(pooi_t2$nutrient,pooi_t2$flow,pooi_t2$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(pooi_t3$nutrient,pooi_t3$flow,pooi_t3$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(pooi_t2$nutrient,pooi_t2$sediment,pooi_t2$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(pooi_t3$nutrient,pooi_t3$sediment,pooi_t3$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(pooi_t2$sediment,pooi_t2$flow,pooi_t2$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(pooi_t3$sediment,pooi_t3$flow,pooi_t3$Observed,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
posi_t2 <- alpha_lm_protist_order_11 %>% filter(week == 2)
posi_t3 <- alpha_lm_protist_order_11 %>% filter(week == 3)

par(mfrow=c(1,1))
interaction.plot(posi_t2$nutrient,posi_t2$flow,posi_t2$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(posi_t3$nutrient,posi_t3$flow,posi_t3$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(posi_t2$nutrient,posi_t2$sediment,posi_t2$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(posi_t3$nutrient,posi_t3$sediment,posi_t3$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(posi_t2$sediment,posi_t2$flow,posi_t2$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(posi_t3$sediment,posi_t3$flow,posi_t3$Shannon,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
popi_t2 <- alpha_lm_protist_order_11 %>% filter(week == 2)
popi_t3 <- alpha_lm_protist_order_11 %>% filter(week == 3)

par(mfrow=c(1,1))
interaction.plot(popi_t2$nutrient,popi_t2$flow,popi_t2$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(popi_t3$nutrient,popi_t3$flow,popi_t3$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(popi_t2$nutrient,popi_t2$sediment,popi_t2$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(popi_t3$nutrient,popi_t3$sediment,popi_t3$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
par(mfrow=c(1,1))
interaction.plot(popi_t2$sediment,popi_t2$flow,popi_t2$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
interaction.plot(popi_t3$sediment,popi_t3$flow,popi_t3$pielou,type = "b",col=c(1:3),
                 leg.bty ="o",leg.bg="beige", lwd=2, pch=c(18,24,22),
...
perm_algae_phylum_sampledf_1 <- perm_algae_phylum_sampledf %>% mutate(across(c(week, flow, sediment, nutrient, time, header_tanks_block, treatment_week), as.factor))
...
perm_algae_order_sampledf_1 <- perm_algae_order_sampledf %>% mutate(across(c(week, flow, sediment, nutrient, time, header_tanks_block, treatment_week), as.factor))
...
perm_protist_phylum_sampledf_1 <- perm_protist_phylum_sampledf %>% mutate(across(c(week, flow, sediment, nutrient, time, header_tanks_block, treatment_week), as.factor))
...
perm_protist_order_sampledf_1 <- perm_protist_order_sampledf %>% mutate(across(c(week, flow, sediment, nutrient, time, header_tanks_block, treatment_week), as.factor))
...
## For the algae phylum level
ap.pcoa = ordinate(sub_algae_phylum_tsc_minthreshold, method="PCoA", distance="bray")
ap_p = plot_ordination(sub_algae_phylum_tsc_minthreshold, ap.pcoa, "samples", color="treatment")+
...
## For the algae order level
ao.pcoa = ordinate(sub_algae_order_tsc_minthreshold, method="PCoA", distance="bray")
ao_p = plot_ordination(sub_algae_order_tsc_minthreshold, ao.pcoa, "samples", color="treatment")+
  geom_line() + geom_point(size=5)+ geom_path()+
  facet_wrap(~week, scales="free")+
...
## For the protist phylum level
pp.pcoa = ordinate(sub_protist_phylum_tsc_minthreshold, method="PCoA", distance="bray")
pp_p = plot_ordination(sub_protist_phylum_tsc_minthreshold, pp.pcoa, "samples", color="treatment")+
  geom_line() + geom_point(size=5)+ geom_path()+
  facet_wrap(~week, scales="free")+
...
## For the protist order level
po.pcoa = ordinate(sub_protist_order_tsc_minthreshold, method="PCoA", distance="bray")
po_p = plot_ordination(sub_protist_order_tsc_minthreshold, po.pcoa, "samples", color="treatment")+
  geom_line() + geom_point(size=5)+ geom_path()+
  facet_wrap(~week, scales="free")+
...
manova_df_algae_phylum_111 <- manova_df_algae_phylum_11 %>% mutate(across(c(week, flow, sediment, nutrient, time, header_tanks_block, treatment_week), as.factor))
...
manova_df_algae_order_111 <- manova_df_algae_order_11 %>% mutate(across(c(week, flow, sediment, nutrient, time, header_tanks_block, treatment_week), as.factor))
...
manova_df_protist_phylum_111 <- manova_df_protist_phylum_11 %>% mutate(across(c(week, flow, sediment, nutrient, time, header_tanks_block, treatment_week), as.factor))
...
manova_df_protist_order_111 <- manova_df_protist_order_11 %>% mutate(across(c(week, flow, sediment, nutrient, time, header_tanks_block, treatment_week), as.factor))
